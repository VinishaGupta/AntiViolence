 <?php
    ...
    if (isset($_POST['submit'])) {
      $user = $_POST['email'];
      $pws = $_POST['pws'];
      $result = "SELECT * FROM registration WHERE `EMAIL ID`='$user' AND `PASSWORD`='$pws'";
            ...
            <form action="login.php" method="post">
                ...
                <div class="abc">
                    ...
                    <!-- <div class="abc1">
                        ...
                        <input class="abc_1" type="tel" id="phone" name="phone" placeholder="Phone Number" maxlength="14" minlength="14">    
                    </div> -->
                    ...
                    <div class="abc1 abc_13">
                        <p class="abc_12">Don't have an account?<span><a class="abc_14" href="signin.html"> Sign up</a></span></p>
                    </div>
